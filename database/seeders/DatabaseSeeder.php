...
class DatabaseSeeder extends Seeder
{
    ...
    //  AccommodationReservation::truncate();
        ...
        DB::table('accommodations')->insert([
          ...
          'accommmodation_description' => 'Šī vēsturiskā greznā viesnīca, kas celta 1860. gadā, atrodas pilī BĪrini Ezers krastā, 14 km attālumā no autoceļa E 67 un 15 km attālumā no Ledurgi dendrārija.',
        ]);
       ...
       DB::table('accommodations')->insert([
          ...
          'accommmodation_description' => 'Esiet vienmēr gaidīti viesu namā „Pie Maijas”! Viesu nams ir iekārtots tā, lai atpūtniekiem piedāvātu mierīgu atpūtu un ļautu baudīt visas priekšsrocības.',
        ]);
       DB::table('accommodations')->insert([
         ...
         'accommmodation_description' => 'Dzīvoklis Barona atrodas Liepājā, 500 metru attālumā no Liepājas pludmales un 400 metru attālumā no Spoku koka. No logiem paveras skats uz pilsētu. Ir pieejams bezmaksas wifi.',
        ]);
        ...
        $accommodation->accommmodation_description = '"Kundziņu salas" - vieta, kurā apstājas laiks un iespēja aizmirst ikdienas steigu un pilsētas kņadu! Lauku miers un klusums tikai stundas braucienā no Rīgas centra.';
        $accommodation->save();
        ...
        $accommodation->accommmodation_description = 'Piedāvājam 2 pirts mājas - Lielo pirti un Jauno pirti.Lielajā pirtī atrodas kamīnzāle kurā var ietilpināt līdz 60 personām. Vasarā iespējams lielāks cilvēku skaits.Jaunajā pirtī ietilps līdz 20 personām.';
        $accommodation->save();
        ...
        $accommodation->accommmodation_description = 'Netālu no Valmieras, simtgadīgu ozolu ieskauta Abula upes krastā atrodas viesu nams "Jaundzērvītes".';
        $accommodation->save();
        ...
        $accommodation->accommmodation_description = 'Viesu nama pirmajā stāvā atrodas ar malku kurināma pirts, svinību zāle ar kamīnu, labiekārtota virtuve silto un auksto ēdienu pagatavošanai.';
        $accommodation->save();
        ...
        $accommodation->accommmodation_description = 'Viesu nams "Vecmuiža" ir viena no senākajām muižām Vidzemē un rakstos tā jau ir minēta 1403.g. Mēs atrodamies skaista meža ielokā, tikai 3 km attālumā no jūras.';
        $accommodation->save();
        ...
        $accommodation->accommmodation_description = 'Viesu nams "Agave" un vasaras māja "Stallis" atrodas Līgatnes novadā (7 km no Augšlīgatnes). Skaistā, klusā, ainaviskā vietā. (Gaujas nacionālā parka teritorijā). Viesiem piedāvājām ērtus numuriņus, skaistu 100 m2 zāli (TV un mūzikas centru), labiekārtotu virtuvi, pirti, apkurināmu baļļu ar zemūdens masāžu un peldi dīķi kā arī vasaras sezonā (no maija līdz oktobrim) eko naktsmītnes - īsta lauku vasaras mājā "Stallis".';
        $accommodation->save();
        ...
        DB::table('accommodations')->insert([
          ...
          'accommmodation_description' => 'Ne visiem zināms, ka ēka, kurā atrodas Zītaru krogs un viesu nams, ir senatnes elpas ieskauta. Mūra ēka Tirgus ielā 11 uzskatāma par vienu no vecākajiem namiem Ventspilī.',
        ]);
